...
> 373×886）是给 README 用的，**不符合商店的 1280×800**。上架时需另导一版 1280×800（把 hero 缩到
> 1280 宽、竖版面板放进 1280×800 画布居中留白即可——这一步可从现有截图批量生成）。
...
**隐私政策 URL（必填）**：因为声明了 host 权限并读取页面内容，商店要求一个**公开的隐私政策链接**。
仓库已公开（2026-08-07），直接用：
<https://github.com/yunmin311/context-distiller/blob/main/docs/PRIVACY.md>
（若审核要求纯文本页，可改挂 GitHub Pages / Gist，内容同 `docs/PRIVACY.md`。）
